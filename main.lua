...
if WindUI then
    ...
    _gui.Name = "MercyToggleGui"
    _gui.ResetOnSpawn = false
    _gui.IgnoreGuiInset = true
    _gui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    _gui.Parent = game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui")

    local _btn = Instance.new("ImageButton")
    _btn.Size = UDim2.new(0, 52, 0, 52)
    _btn.Position = UDim2.new(0, 12, 0.5, -26)
