...
PlayerTab:Divider()
PlayerTab:Section({Title = "Custom Animation"})

local WALK_SPEED_THRESHOLD = 16
local customAnimEnabled = false
local customAnimConnection = nil

local function onCustomAnimCharAdded(character)
    local humanoid = character:WaitForChild("Humanoid")
    ...
    idle.Animation1.AnimationId = "http://www.roblox.com/asset/?id=101395235813499"
    idle.Animation2.AnimationId = "http://www.roblox.com/asset/?id=101395235813499"
    walk.WalkAnim.AnimationId = "http://www.roblox.com/asset/?id=79786759005429"
    run.RunAnim.AnimationId = "http://www.roblox.com/asset/?id=79786759005429"
    local walkAnim = Instance.new("Animation")
    walkAnim.AnimationId = "rbxassetid://79786759005429"
    ...
    loadAndSetAnimation(jump)
    loadAndSetAnimation(fall)
    loadAndSetAnimation(climb)
...
PlayerTab:Toggle({
    ...
    Callback = function(v)
        customAnimEnabled = v
        if v then
            onCustomAnimCharAdded(LocalPlayer.Character or LocalPlayer.CharacterAdded:Wait())
            customAnimConnection = LocalPlayer.CharacterAdded:Connect(onCustomAnimCharAdded)
        else
